<%-- 
    ...
    Created on : Oct 25, 2022, 10:25:46 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            <h1 class="text-center m-b-50">Create new Course</h1>
            <form action="createCourse" method="post" id="addForm" style="width: 90%; margin: 0 auto">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="info" id="info" form="addForm"  rows="3"></textarea>
                    </div>
                </div>
                <div class="form-group row">
